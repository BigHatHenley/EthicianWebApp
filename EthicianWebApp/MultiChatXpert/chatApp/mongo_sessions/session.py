...
from django.utils.encoding import force_str  # Use force_str instead of force_unicode or force_text
...
class SessionStore(SessionBase):
    ...
    def load(self):
        ...
        if not mongo_session is None:
            return self.decode(force_str(mongo_session['session_data']))
        else:
